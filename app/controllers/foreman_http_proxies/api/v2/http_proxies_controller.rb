module ForemanHttpProxies
  module Api
    module V2
      class HttpProxiesController < ::Api::V2::BaseController
        include ::Api::Version2
        include ::Api::TaxonomyScope
        include ForemanHttpProxies::Concerns::Parameters::HttpProxy
        ...
        def_param_group :http_proxy do
          param :http_proxy, Hash, :required => true, :action_aware => true do
            ...
            param :port, Integer, :required => true, :desc => N_('Port to use for the HTTP Proxy')
